...
namespace IOL\Dashboard\v1\Request;
...
class APIResponse
{
     ...
     * time
     *
     * @see \IOL\Dashboard\v1\Request\APIResponse::render()
     * @see _loader.php:29
     */
     ...
     *
     * @see \IOL\Dashboard\v1\Request\APIResponse::getInstance() Actual instantiation happens here
     */
